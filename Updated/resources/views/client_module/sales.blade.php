...
<body>
  <div id="wrapper">
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
          ...
          <li class="active"><a href='sales'><i class="fa fa-globe"></i> Sales</a></li>
    ...
    <div id="page-wrapper">
            ...
            <table class="table table-bordered table-striped mb-none" id="datatable-default">
              <thead>
                <tr>
                 ...
                 <th style="text-align:center;">Type of Sale</th>
             ...
             <tbody>
               @foreach($displaySales as $sale)
                    </tr>
                      <td style="text-align:center;">{{$sale->or_number}}</td>
                      <td>{{$sale->name}}</td>
                      <td>{{$sale->order_type}}</td>
                      <td>₱{{$sale->cost}}</td>
                      <td>{{$sale->created_at}}</td>
                      <td style="text-align:center;"><button type="button" class="btn btn-success" data-toggle="modal" data-target="#sale{{$sale->order_id}}"> View Details </button></td>
                    </tr>
                  @endforeach
            </tbody>
          </table>
     ...
     <!-- End of Main Content -->
    @foreach($displaySales as $sale2)
      <div class="modal fade" id="sale{{$sale2->order_id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        ...
        @foreach($orderDetails as $det)
          @if($sale2->order_id == $det->order_id)
          <tr>
          <th scope="row"> {{$det->inventory_item}}</th>
          <td> {{$det->cost}}</td>
          </tr>
          @endif
        @endforeach       
