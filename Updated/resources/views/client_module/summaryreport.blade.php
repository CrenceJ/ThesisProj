...
-->
		...
		<div class="container-fluid">
          <div class="container text-right">
          <a href="customize.html"><button type="button" class="btn btn-primary d-inline">&laquo; Back</button></a>
        </div>
        <br>
        <div class="container-fluid">
  ...
  <!-- Specifying an 'open' attribute will make all the content visible when the page loads -->
    ...
    <table>
      ...
      <tr>
        ...
        <td>EAS190890823985909485</td>
      </tr>
        <tr>
        <th scope="row">Accessories</th>
        <td>Charger, Laptop Bag</td>
      </tr>
    ...
    <tr>
        <th scope="row">Picked up Date</th>
        <td>October 27,2017</td>
      </tr>

          <tr>
        <th scope="row">Picked up By:</th>
        <td>Graeham Solis</td>
      </tr>
        ...
        <td> 
             <div class='col-sm-4'>
                   ...
                   <select class='form-control' id='event_category' type='text'>
                    ...
                    <option value='wtp'>Waiting to Pickup</option>
