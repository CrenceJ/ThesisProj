...
Route::group(['middleware' => ['App\Http\Middleware\ServiceEngineerMiddleware']], function(){
    ...
    Route::get('/info', ['as' => 'purchase-parts', 'uses' => 'OrderController@index'])->middleware('auth');
    ...
    Route::get('/summaryreport', ['as' => 'summary', 'uses' => 'InventoryController@store'])->middleware('auth');
