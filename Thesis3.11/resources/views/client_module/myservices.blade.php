 ...
 <div id="wrapper">
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="mb-md">
            <a class="btn btn-primary" href="{{ url('serviceform?type=others') }}">Add Services <i class="fa fa-plus"></i></a>
            <a class="btn btn-primary" href='/orders'>orders <i class="fa fa-plus"></i></a>
          </div>
        </div>
      </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><a href="#" data-toggle="modal" data-target="#service-details{{$service->srf_no}}" class="m-0 font-weight-bold text-primary">{{$service->srf_no}}</a></td>
                        ...
                        <td style="text-align:right;">{{$service->service_cost}}</td>
                        <td class="actions">
              ...
              <!--<details> -->
                ...
                <table>
                  ...
                  <tr>
                    ...
                    <th scope="row"></th>
                    <td><span id="items-cost-container{{$service2->client->client_id}}"><button class="btn btn-primary" onclick="itemCost({{ $service2->client->client_id }})"> View Cost </button></span>
                    </td>
                  </tr>
