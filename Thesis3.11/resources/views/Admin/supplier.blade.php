    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
          ...
          <li class="active"><a href='suppliers'><i class="fa fa-users"></i> Suppliers</a></li>
                      ...
                      <section class="panel">
                        <div class="panel-body">
                          ...
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="mb-md">
                               <a class="btn btn-primary" href='supplierForm'>Add Suppliers <i class="fa fa-plus"></i></a>
                             </div>
                           </div>
                         </div>
                          ...
                          <thead>
                           ...
                           <tbody>
                          @foreach($posts as $supplier)
                          <tr class="gradeX">
                           <td>{{$supplier -> supplier_name}}</td>
                           <td>{{$supplier -> supplier_contactno}}</td>
                           <td>{{$supplier -> supplier_address}}</td>
                           <td>{{$supplier -> supplier_contactperson}}</td>
                           <td class="actions">
                            <form action='/deleteIn' method="POST"> 
                              {{ csrf_field()}}
                              <input hidden name="in_id" value="{{$supplier->supplier_id}}">
