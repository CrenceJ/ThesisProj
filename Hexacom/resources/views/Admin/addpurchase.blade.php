        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                  ...
                  <li class='salesRecord'><a href='purchases'><i class="fa fa-globe"></i> Sales Records</a></li>
          ...
          <li class="dropdown user-dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> sdfsfdsfgfdg</a>
            <ul class="dropdown-menu">
                    ...
                    <form class="form-horizontal form-bordered" action="#">
                      ...
                      <div class="form-group">
                        ...
                        <!--ending & start-->
                         ...
                         <div class="form-group">
                        <label class="col-md-3 control-label" for="inputDefault">Service Engineer</label>
                        <div class="col-md-3">
                          <input type="text" class="form-control" id="inputDefault">
                        </div>
                      </div>
                      <!--ending & start-->
                       <div class="form-group">
                        <label class="col-md-3 control-label" for="inputDefault">Cash Invoice</label>
                        <div class="col-md-3">
                          <input type="text" class="form-control" id="inputDefault">
                        </div>
                      </div>
