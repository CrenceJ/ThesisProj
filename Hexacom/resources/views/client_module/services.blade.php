      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12 text-center">
            <a href="/myservices"><button type="buttonMy" class="btn btn-outline-primary .navbar-center" style="width:320px;height:80px;"><img src="img/icons8-administrative-tools-48.png"><br>My Services</button></a>
            <a href="/allservices"><button type="buttonAll" class="btn btn-outline-primary .navbar-center" style="width:320px;height:80px;"><img src="img/icons8-services-48.png"><br>All Services</button></a>
            <a href="/addservices"><button type="buttonAll" class="btn btn-outline-primary .navbar-center" style="width:320px;height:80px;"><img src="img/add-button-inside-black-circle.png"><br>Add Service</button></a>
          </div>
        </div>
      </div>
    </div>
