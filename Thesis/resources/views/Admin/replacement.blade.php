          ...
          <section class="panel">
            ...
            <div class="panel-body">
              ...
              <div class="row">
                            <div class="col-sm-6">
                              <div class="mb-md">
                                <a class="btn btn-primary" href='addreplacement'>Add New Replacement <i class="fa fa-plus"></i></a>
                              </div>
                            </div>
                          </div>
              ...
              <table class="table table-bordered table-striped mb-none" id="datatable-default">
                ...
                <tbody>
                  ...
                  <tr class="gradeX">
                    ...
                    <td>{{$replacement -> srf_no}}</td>
                    <td>{{$replacement -> credit_no}}</td>
                    ...
                    <td>{{$replacement -> supplier}}</td>
                    <td>{{$replacement -> date_recieved}}</td>
