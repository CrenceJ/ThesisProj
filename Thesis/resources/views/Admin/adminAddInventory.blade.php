                        ...
                        <div class="col-xs-12">
                          <section class="panel">
                            ...
                            <div class="panel-body">
                              ...
                              <form class="form-horizontal form-bordered" action='inventoryForm' method="POST">
                                <div id="app">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-3">
                                    <input name="description" type="text" class="form-control" id="inputDefault" value="{{ old('description') }}">
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-3">
                                    <input name="supplier" type="text" class="form-control" id="inputDefault" value="{{ old('supplier') }}">
                                  </div>
                                </div>
                                <!--ending & start-->
                                <div class="form-group">
                                  ...
                                  <div class="col-md-3">
                                    <input type="date" data-plugin-datepicker id="inputDate" class="form-control form-control-user" placeholder="Birthday" name="date" value="{{ old('date') }}">
                                  </div>
                                </div>
                                <!--ending & start-->
                                <div class="form-group">
                                  ...
                                  <div class="col-md-3">
                                    <input name="serial" type="text" class="form-control" id="inputDefault">
                                  </div>
                                </div>
                                ...
                                <div class="text-right">
                                  ...
                                  <a href='inventory_admin' class="btn btn-success btn-user ">Done</a>
                                </div>
